...
exports.SPHINX_NETWORKS = exports.SPHINX_LOCAL_NETWORKS = exports.calculateActionLeafGasForMoonbeam = void 0;
const calculateActionLeafGasForMoonbeam = (foundryGas, deployedContractSizes, access) => {
    return (10896000).toString();
};
exports.calculateActionLeafGasForMoonbeam = calculateActionLeafGasForMoonbeam;
exports.SPHINX_LOCAL_NETWORKS = [
    {
        name: 'anvil',
...
exports.SPHINX_NETWORKS = [
    ...
    },
    {
        ...
        eip2028: true,
        handleNetworkSpecificMerkleLeafGas: exports.calculateActionLeafGasForMoonbeam,
    },
    {
        name: 'moonbeam',

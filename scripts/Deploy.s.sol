...
import {Script, console2} from "@layerzerolabs/toolbox-foundry/lib/forge-std/Script.sol";

import {MocaToken} from "./../contracts/token/MocaToken.sol";
import {MocaOFT} from "./../contracts/token/MocaOFT.sol";
import {MocaTokenAdaptor} from "./../contracts/token/MocaTokenAdaptor.sol";
